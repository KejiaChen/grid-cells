...
_DATASETS = dict(
        square_room=DatasetInfo(
            basepath='square_room_100steps_2.5m_vision_100',
            size=100,  # 100 files
...
def run_demo():
    ...
    # start test
    episode_length = 100  # every trajectory has 100 steps
    file_length = 100  # every file contains 10000 trajectories
    time_episodes_num = 100 * episode_length * file_length * 2
    ...
    for t in range(time_episodes_num):
        ...
        if t % episode_length == 0:
            ...
            if ep % file_length == 0:
                record_path = "/data/bing/kejia/dm_lab_data/"
